	...
	<?php 
		$no=1;
		$query = mysqli_query($koneksi,"SELECT * FROM complain INNER JOIN akun_user ON complain.id_user=akun_user.id_user 
		INNER JOIN tindak_lanjut ON complain.no_antrian=tindak_lanjut.no_antrian INNER JOIN akun_admin ON 
		tindak_lanjut.id_admin=akun_admin.id_admin ORDER BY tindak_lanjut.no_antrian ASC");
		...
		<tr>
			...
			<td><a class="btn blue modal-trigger" href="#more?id_tanggapan=<?php 
			echo $r['id_lanjut'] ?>">More</a> 
