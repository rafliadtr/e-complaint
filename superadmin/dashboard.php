...
<h3 class="blue-text"><b>Dashboard</b></h3>
	...
	<div class="col s4">
		...
		<div class="col s4">
		    ...
		    <div class="card-content white-text">
			<?php 
				$query = mysqli_query($koneksi,"SELECT * FROM complain WHERE status='selesai'");
				$panggil = mysqli_num_rows($query);
				if($panggil<1){
					$panggil=0;
				}
		...
		<div class="col s4">
		  <div class="card blue">
		    <div class="card-content white-text">
			<?php 
				$query = mysqli_query($koneksi,"SELECT * FROM complain");
				$panggil = mysqli_num_rows($query);
				if($panggil<1){
					$panggil=0;
				}
			 ?>
		      <span class="card-title">Total Keluhan Masuk<b class="right"><?php echo $panggil; ?></b></span>
		      <p></p>
		    </div>
		  </div>
		</div>	
