<?php 
	...
	elseif($_SESSION['level'] != "akun_user"){
		header('location:../index.php');
	}
 ?>
  <!DOCTYPE html>
          ...
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
                      ...
                      <a href="#name"><span class="blue-text name"><?php echo ucwords($_SESSION['data']['nama_user']); ?></span></a>
                  </div>
              </li>
              <li><a href="index.php?p=dashboard"><i class="material-icons">dashboard</i>Dashboard</a></li>
              
              <li><a href="index.php?p=faq"><i class="material-icons">quiz</i>FAQ</a></li>
              <li>
